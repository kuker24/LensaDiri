...
| Curated preset dan Full Spectrum            | §11     | `PARTIAL`              | 4 fit-coverage + `deep_self_discovery` **pilot** (2026-07-26 Complex ON). `full_spectrum` preset tetap draft; custom 1–10 lensa auto-expands ke minimum coverage dan memakai segment plan (2026-07-29).                                                                                                             |
