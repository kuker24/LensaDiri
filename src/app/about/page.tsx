    ...
    <section className="container-shell py-16 sm:py-24">
      <article className="max-w-4xl">
        ...
        <p className="text-ink-muted mt-6 text-lg leading-8">
          ...
          primer dihitung secara deterministik di server, lalu hubungan antar-lensa dijelaskan tanpa
        ...
        <div className="border-line mt-12 grid border-y md:grid-cols-2">
          <section className="border-line py-7 md:border-r md:pr-8">
            <h2 className="text-ink text-xl font-normal tracking-[-0.02em]">Yang kami lakukan</h2>
          ...
          <section className="py-7 md:pl-8">
            <h2 className="text-ink text-xl font-normal tracking-[-0.02em]">
        ...
        <div className="mt-10">
          <Link href="/modules" className={cn(getButtonClassName("primary", "md"), "inline-flex")}>
            Lihat katalog modul <span aria-hidden="true">↗</span>
          </Link>
        </div>
      </article>
    </section>
