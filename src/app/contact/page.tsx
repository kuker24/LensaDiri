      ...
      <article className="max-w-3xl">
        ...
        <div className="mt-8 space-y-5">
          <section className="border-line shadow-surface rounded-md border bg-white p-6">
            <h2 className="font-display text-ink text-xl font-semibold">Dukungan produk</h2>
          ...
          <section className="border-danger-soft bg-danger-soft text-danger rounded-md border p-6">
