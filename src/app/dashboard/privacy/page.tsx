...
export default async function DashboardPrivacyPage() {
  ...
  return (
    <main className="container-shell py-14 sm:py-20">
            ...
            >
              ...
              <dl className="mt-4 grid gap-3 text-sm sm:grid-cols-3">
                <div>
                  ...
                  <dd className="mt-1 text-[var(--muted)]">{policy.version}</dd>
                </div>
                <div>
                  <dt className="font-semibold">Data</dt>
                  <dd className="mt-1 text-[var(--muted)]">{policy.retentionSubject}</dd>
                </div>
                <div>
      ...
      <section
        className="mt-10 max-w-4xl rounded-2xl border border-violet-200 bg-violet-50 p-6"
      ...
      <section
        className="mt-10 max-w-4xl rounded-2xl border border-red-200 bg-red-50 p-6 sm:p-8"
