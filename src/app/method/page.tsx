...
export default function MethodPage() {
  return (
    <section className="container-shell py-16 sm:py-24">
      ...
      <div className="border-line mt-14 grid border-y lg:grid-cols-3">
        {tiers.map((item) => (
          <article
            className="border-line py-8 lg:border-r lg:px-7 lg:first:pl-0 lg:last:border-r-0 lg:last:pr-0"
            key={item.tier}
          >
            <div className="mb-4">
      ...
      <div className="bg-line mt-14 grid gap-px overflow-hidden rounded-lg border border-white/12 lg:grid-cols-2">
        <article className="bg-surface p-7 sm:p-9">
          <h2 className="text-ink text-2xl font-medium">Aturan scoring</h2>
        ...
        <article className="bg-surface p-7 sm:p-9">
          <h2 className="text-ink text-2xl font-medium">Batasan penting</h2>
          <ul className="text-ink-muted mt-5 space-y-3 leading-7">
