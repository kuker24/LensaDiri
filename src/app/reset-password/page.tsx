...
export default function ResetPasswordPage() {
  return (
    <section className="container-shell py-14 sm:py-20">
      <div className="border-line shadow-surface mx-auto max-w-xl rounded-lg border bg-white p-7 sm:p-10">
        <p className="text-lens text-sm font-semibold">Pemulihan akun</p>
        <h1 className="font-display text-ink mt-2 text-3xl font-semibold">Atur password baru</h1>
