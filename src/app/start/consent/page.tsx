...
export default async function ConsentPage({
  ...
  return (
    <section className="container-shell py-14 sm:py-20">
      <div className="mx-auto max-w-2xl rounded-lg border border-line bg-white p-7 shadow-surface sm:p-10">
        <p className="text-sm font-semibold text-lens">Sebelum mulai</p>
        <h1 className="font-display mt-3 text-3xl font-semibold tracking-tight">
          Consent pemrosesan assessment
        </h1>
        <ul className="mt-6 space-y-3 leading-7 text-ink-muted">
