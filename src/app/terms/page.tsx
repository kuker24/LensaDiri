    ...
    <main className="container-shell py-12 sm:py-18">
      <article className="prose-shell">
        ...
        <div className="text-ink-muted mt-8 space-y-7 leading-8">
          <section>
            <h2 className="font-display text-ink text-xl font-semibold">Ruang lingkup</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display text-ink text-xl font-semibold">Akun dan keamanan</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display text-ink text-xl font-semibold">Konten dan interpretasi</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-display text-ink text-xl font-semibold">Privasi dan penghapusan</h2>
            <p className="mt-2">
