...
export function ModularLaunchCard() {
  return (
    <div className="lens-glow bg-lens-strong text-canvas shadow-surface relative mx-auto mt-10 max-w-4xl overflow-hidden rounded-lg p-7 sm:flex sm:items-center sm:justify-between sm:gap-8 sm:p-9">
      <div>
