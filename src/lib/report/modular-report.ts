...
const constructLabels: Readonly<Record<string, string>> = {
  ...
  // The nine Enneagram patterns are emitted as pattern_1..pattern_9. Without
  // these the fallback produced "Pattern 1 cukup menonjol dalam jawabanmu" -
  // an internal identifier, in English, in the middle of Indonesian prose.
  pattern_1: "dorongan menjaga standar",
  pattern_2: "dorongan membantu orang lain",
  pattern_3: "dorongan mencapai hasil",
  pattern_4: "dorongan mencari makna pribadi",
  pattern_5: "dorongan memahami lebih dalam",
  pattern_6: "dorongan bersiap dan waspada",
  pattern_7: "dorongan mencari kemungkinan baru",
  pattern_8: "dorongan mengambil kendali",
  pattern_9: "dorongan menjaga ketenangan",
