...
const moduleResult: IndependentModuleResult = {
  ...
  scores: [
    { confidence: 1, constructKey: "openness", facetKey: "general", normalizedScore: 76, rawScore: 4.1 },
    { confidence: 1, constructKey: "conscientiousness", facetKey: "general", normalizedScore: 68, rawScore: 3.8 },
    { confidence: 1, constructKey: "extraversion", facetKey: "general", normalizedScore: 42, rawScore: 2.7 },
    { confidence: 1, constructKey: "agreeableness", facetKey: "general", normalizedScore: 61, rawScore: 3.5 },
    { confidence: 1, constructKey: "emotional_sensitivity", facetKey: "general", normalizedScore: 30, rawScore: 2.2 },
  ],
